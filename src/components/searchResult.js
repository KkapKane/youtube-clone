...
export default function SearchResult({
  ...
  const channelLink = isHomePage
    ? "https://youtube.com/channel/" + vid.snippet.channelId
    : "https://youtube.com/channel/" + vid.id.channelId;
  //channel link when it's type is video
  const channelLink2 = isHomePage
    ? "https://youtube.com/channel/" + vid.snippet.channelId
    : "https://youtube.com/channel/" + vid.snippet.channelId;
        ...
        <div className='test'>
          {resultType == "youtube#channel" ? (
            ...
            <div className='thumbnailDuration'>
              <img
                onClick={() => NavToWatchPage(vid, videoId)}
                className='videoImg'
                src={imgSrc}
                alt=''
              />
          ...
          <div className='videoInfo'>
            ...
            {resultType == "youtube#channel" ? (
              <div style={{ fontSize: ".8rem" }} className='description'>
                <div style={{ color: "black" }}>
                  {ConvertToM(subCount)} subscribers
                </div>
              ...
              {isHomePage ? (
                <div className='videoInfoBox'>
                  ...
                  <div className='channelNameAndInfo'>
                    <div onClick={() => NavToWatchPage(vid, videoId)}>
                      <div className='vidTitle'>{vid.snippet.title}</div>{" "}
                    </div>
                  ...
                  {isHomePage ? null : resultType == "youtube#video" ? (
